...
def unet_3p(input_size=(240, 240, 3)):
    inputs = Input(input_size)
    outputs = unet_3plus_2d(input_size,2,[32,64, 128, 256, 512],filter_num_skip = [64,64,64,64],filter_num_aggregate = 256,stack_num_down = 2,stack_num_up = 1,deep_supervision=False,backbone='DenseNet201',weights=None
                            ,pool='max', unpool=True,batch_norm=True,freeze_batch_norm=False,freeze_backbone=False,activation='ReLU')(inputs)
